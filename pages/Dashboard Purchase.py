...
#region Rata-rata Harga Satuan
        st.subheader("⚖️ Average Unit Price by Vendor for Each Item")
        ...
        if df_sb.empty:
            ...
            if isinstance(year_option, str) and " vs " in year_option:
                ...
                if df_pair.empty:
                    ...
                    # Checkbox Select All
                    select_all_pair = st.checkbox("✅ Select All Vendors", value=False, key="select_all_pair")
...
#region Tren Month
        ...
        # ✅ MODE 2: Item Comparison (Multiple items dalam satu chart)
            ...
            # ✅ TAMBAHAN: Select All checkbox (tanpa emoji)
...
#region Tren Mingguan
        ...
        # ✅ TAMBAHAN: Select All untuk Months
        if available_months:
        ...
        if not selected_months:
            ...
            if weekly_trend_mode == "Item Trend":
                ...
                if weekly_df.empty:
                    ...
                    # ✅ TAMBAHAN: Select All untuk Items (hanya jika lebih dari 1 item)
                    if len(items_week) > 1:
...
#region Top City
            st.subheader("🌆 Top Cities by Purchase")
