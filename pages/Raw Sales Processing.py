    ...
    try:
        with st.spinner('Processing A/R Invoice Data...'):
            ...
            if apply_item_filter_ar and 'Item Description' in df_merged_ar.columns:
                ...
                st.info(f'🔍 Filter Item Description aktif: Hanya Zak, Jagung, Wheat, Ampok, Ratu Merak, Corn, Ingredient ({filtered_item_count} baris dihapus)')
                ...
                st.info('ℹ️ Filter Item Description tidak aktif - semua item dipertahankan')
